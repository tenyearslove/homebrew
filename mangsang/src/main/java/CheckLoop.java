...
//        test();
    ...
    public static void execute() throws Exception {
        String URL = "http://m.campingkorea.or.kr/pages/booking.htm?res_For=1&res_Day=2019-08-11&home=ms&mode=step02";
        ...
        while (true) {
            ...
            try {
                Document doc = Jsoup.connect(URL)
                        .cookie("PHPSESSID", "7095583bcd78885ef7b6350a556f9b01")
                        .get();
                ...
                while (radioIter.hasNext()) {
                    ...
                    if (roomName.equals("cabin_a") || roomName.equals("cabin_b") || roomName.equals("cortes_a")) {
                        System.out.println("8/11 " + roomName + " " + isAvailable);
                        if (isAvailable) {
                            FirebaseAdminSdk.request();
//                            return;
