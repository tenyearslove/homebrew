    ...
    public static String[] doLogin() {
        ...
        try {
            Connection indexConnection = Jsoup.connect(INDEX_URL)
                    .method(Connection.Method.GET);
            MobileReservation.addDefaultHeader(indexConnection, null);
            ...
            Connection loginConnection = Jsoup.connect(LOGIN_URL)
                    .method(Connection.Method.GET)
                    .cookie(session[0], session[1]);
            MobileReservation.addDefaultHeader(loginConnection, INDEX_URL);
            ...
            MobileReservation.addDefaultHeader(connection, LOGIN_URL);
            Connection.Response response = connection.execute();
